...
const createBioPage = () => {
  ...
  <div class="col-6">
    ...
    <br/>
    <p class="indented">I like playing videogames, solving puzzles, watching documentaries, and spending time with my wife, Rachel, and my dogs, Logan and Nora.  When I have time, I love to travel, go backpacking, and explore new places.  
